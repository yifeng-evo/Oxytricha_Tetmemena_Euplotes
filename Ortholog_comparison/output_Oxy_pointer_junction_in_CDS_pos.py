...
ewoo_gff3=open("/N/u/yif/Carbonate/yif/3species_ms/MAC_genomes/Gene_annotation/Oxytricha_trifallax_022112_telo.exon.gff3","r")
Ewoo_cds_fna=open("/N/u/yif/Carbonate/yif/3species_ms/MAC_genomes/Gene_annotation/Oxytricha_trifallax_022112_telo.CDS.fna","r")
eijunction_cds=open("Oxy_pointer_labeled_in_CDS_pos.txt","w")
pointer_junction=open("concise_below30master_Scramble_sdrap_oxy_1025_pid95_add90_prod_pointers.bed","r")

ewoopd={}
for line in f:
	ewooP=line.split("\t")[2] #oxy
	OG=line.split("\t")[0]
...
for line in ewoo_gff3:
	...
	id_e=line.rfind(";")
	ewooPid=line[id_s+7:id_e]#including.1,but not _1
