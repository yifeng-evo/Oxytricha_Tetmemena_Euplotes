...
ewoo_gff3=open("/N/u/yif/Carbonate/yif/3species_ms/MAC_genomes/Gene_annotation/Ewoo_EVM_telov4.4_intron.gff3","r")
Ewoo_cds_fna=open("/N/u/yif/Carbonate/yif/3species_ms/MAC_genomes/Gene_annotation/Ewoo_EVM_telov4.4.CDS.fna","r")
eijunction_cds=open("Ewoo_exon_junction_labeled_in_CDS_pos.txt","w")
