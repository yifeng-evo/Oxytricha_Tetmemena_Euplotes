...
ewoo_gff3=open("/N/u/yif/Carbonate/yif/3species_ms/MAC_genomes/Gene_annotation/Oxytricha_trifallax_022112_telo_intron.gff3","r")
...
eijunction_cds=open("Oxy_exon_junction_labeled_in_CDS_pos.txt","w")
