...
ewoo_gff3=open("/N/u/yif/Carbonate/yif/3species_ms/MAC_genomes/Gene_annotation/tetpusstrmac_2019_telo_longestisoform.CDS.gff3","r")
...
eijunction_cds=open("Tet_pointer_labeled_in_CDS_pos.txt","w")
pointer_junction=open("concise_below30master_Scramble_sdrap_tet_10272020_pid95_add90_prod_pointers.bed","r")

ewoopd={}
for line in f:
	ewooP=line.split("\t")[3][:-1] #Tet
	OG=line.split("\t")[0]
